...
class AliyunMonitor:
    def __init__(self, url):
        self.access_id = '6g9XSwedsWQ9TE1a'
        self.access_secret = 'ibrAEBLAA0GLK9IrRHSTPmyabuyI47'
        self.url = url
...
@app.route('/')
def index():
    T = AliyunMonitor("https://dns.aliyuncs.com")
    results = T.do_request({"Action": "DescribeDomainRecords", "DomainName": "cloveros.com"})
    print results
    print results['DomainRecords']['Record']['RR'][1]
    return "ok"
